...
parser.add_argument(
    ...
    "--output",
    required=True,
    help="Where to save generated clash config file."
)
...
class Xary:
    ...
    def __init__(self,
                 ...
                 outputFile: str = "./generated_clash_conf.yaml",
                 ) -> None:
        self.config = config
        self.base   = baseFile
        self.out    = outputFile
    ...
    def convert_to_clash_yaml(self):
            ...
            if inbound["protocol"] == "vmess":
                for client in inbound["settings"]["clients"]:
                    tmp_conf = {
                        ...
                        "uuid": client["id"],
                        "alterId": client["alterid"] if "alterid" in client else 0,
                        "cipher": "chacha20-poly1305",
                        "udp": False,
                        "tls": True if "security" in inbound["streamSettings"] and inbound["streamSettings"]["security"] == "tls" else False,
...
if __name__ == "__main__":
    ...
    x = Xary(config=args.config, domainName=args.domain, serverIp=args.server, baseFile=args.base, outputFile=args.output)

    x.convert_to_clash_yaml()
